...
public class CidadeController {
	...
	public ResponseEntity<Cidade> atualizar(@PathVariable Long cidadeId,
		...
		Optional<Cidade> cidadeOrigem = cidadeRepository.findById(cidadeId);
		
		if (cidadeOrigem != null) {
			BeanUtils.copyProperties(cidade, cidadeOrigem.get(), "id");
			
			Cidade cidadeAtual = cadastroCidade.salvar(cidadeOrigem.get());
